...
export function ConfirmDeleteProjectDialog({ model }: { model: ProjectPageModel }) {
  return (
    <Dialog open={model.deleteDialog.open} onOpenChange={model.deleteDialog.setOpen}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This action is permanent and cannot be undone. It will delete all tasks associated with this project.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="space-x-2">
          <Button
